...
export default function Deck (jokers, numDecks) {
  // init cards array
  var cardsPerDeck = jokers ? 54 : 52;
  var cards = new Array(cardsPerDeck*numDecks);
  ...
  for (var i = cards.length; i; i--) {
    card = cards[i - 1] = Card((i - 1)%cardsPerDeck)
    card.mount($el)
  }
